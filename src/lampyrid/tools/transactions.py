...
def create_transactions_server(client: FireflyClient) -> FastMCP:
	...
	async def create_withdrawal(req: CreateWithdrawalRequest) -> Transaction:
		"""Record expenses and spending. Money leaves your asset accounts to pay for goods,
		services,or cash withdrawals. Can be assigned to budgets for expense tracking.
		"""
