...
class AvailableBudgetProperties(BaseModel):
    created_at: AwareDatetime | None = Field(None, examples=['2026-01-01T00:00:00+00:00'])
    updated_at: AwareDatetime | None = Field(None, examples=['2026-01-01T00:00:00+00:00'])
    ...
    start: AwareDatetime | None = Field(
        ...
        examples=['2026-01-31T23:59:59+00:00'],
    )
...
class BudgetLimitStore(BaseModel):
    ...
    start: date_aliased = Field(
        ..., description='Start date of the budget limit.', examples=['2026-01-01']
    )
    period: str | None = Field(
        None,
        description='Period of the budget limit. Only used when auto-generated by auto-budget.',
        ...
        ..., description='End date of the budget limit.', examples=['2026-01-31']
    )
...
class WebhookTriggerArray(RootModel[list[WebhookTrigger]]):
    root: list[WebhookTrigger] = Field(
        ...,
        examples=[['STORE_TRANSACTION', 'UPDATE_TRANSACTION']],
        max_length=3,
        min_length=1,
    )
...
class Data(BaseModel):
    version: str | None = Field(None, examples=['6.4.16'])
    api_version: str | None = Field(
        None, description='Same value as the version field.', examples=['6.4.16']
    )
...
class ChartDataSet(BaseModel):
    ...
    date: AwareDatetime | None = Field(None, examples=['2026-01-01T00:00:00+00:00'])
    start_date: AwareDatetime | None = Field(None, examples=['2026-01-01T00:00:00+00:00'])
    end_date: AwareDatetime | None = Field(None, examples=['2026-01-31T23:59:59+00:00'])
    type: str | None = Field(
        None,
...
class AccountUpdate(BaseModel):
    ...
    opening_balance_date: AwareDatetime | None = Field(None, examples=['2026-01-01T00:00:00+00:00'])
    virtual_balance: str | None = Field(None, examples=['123.45'])
    currency_id: str | None = Field(
        None,
        description="Use either currency_id or currency_code. Defaults to the user's financial administration's currency.",
...
class BillStore(BaseModel):
    ...
    date: AwareDatetime = Field(..., examples=['2026-01-01T00:00:00+00:00'])
    end_date: AwareDatetime | None = Field(
        None,
