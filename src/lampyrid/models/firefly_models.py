...
#   filename:  firefly-iii-6.2.21-v1.yaml
#   timestamp: 2025-08-09T09:17:51+00:00
...
class AutocompleteBill(BaseModel):
	...
	active: Optional[bool] = Field(None, description='Is the bill active or not?', examples=[True])
...
class CategoryEarned(BaseModel):
	...
	sum: Optional[str] = Field(None, description='The amount earned.', examples=['123.45'])
...
class CategorySpent(BaseModel):
	...
	sum: Optional[str] = Field(None, description='The amount spent.', examples=['-12423.45'])
...
class ObjectGroupUpdate(BaseModel):
	title: str = Field(..., examples=['My object group'])
	order: Optional[int] = Field(None, description='Order of the object group', examples=[1])
...
class ObjectLink(BaseModel):
	self: Optional[AnyUrl] = Field(None, examples=['https://demo.firefly-iii.org/api/v1/OBJECTS/1'])
...
class PiggyBankAccountUpdate(BaseModel):
	account_id: Optional[str] = Field(None, description='The ID of the account.', examples=['3'])
	name: Optional[str] = Field(
		None, description='The name of the account.', examples=['Checking account']
	)
	current_amount: Optional[str] = Field(
...
class RecurrenceTransactionStore(BaseModel):
	...
	piggy_bank_id: Optional[str] = Field(None, description='Optional.', examples=['123'])
...
class RuleGroup(BaseModel):
	...
	description: Optional[str] = Field(None, examples=['Description of this rule group'])
...
class Currency(BaseModel):
	created_at: Optional[datetime] = Field(None, examples=['2018-09-17T12:46:47+01:00'])
	updated_at: Optional[datetime] = Field(None, examples=['2018-09-17T12:46:47+01:00'])
	enabled: Optional[bool] = Field(True, description='Defaults to true', examples=[True])
	...
	decimal_places: Optional[int] = Field(None, description='Supports 0-16 decimals.', examples=[2])
...
class CurrencyUpdate(BaseModel):
	enabled: Optional[bool] = Field(None, description='If the currency is enabled', examples=[True])
	...
	symbol: Optional[str] = Field(None, description='The currency symbol', examples=['AM$'])
...
class WebhookMessage(BaseModel):
	created_at: Optional[datetime] = Field(None, examples=['2018-09-17T12:46:47+01:00'])
	updated_at: Optional[datetime] = Field(None, examples=['2018-09-17T12:46:47+01:00'])
	sent: Optional[bool] = Field(None, description='If this message is sent yet.', examples=[False])
...
class AccountUpdate(BaseModel):
	...
	opening_balance_date: Optional[datetime] = Field(None, examples=['2018-09-17T12:46:47+01:00'])
	virtual_balance: Optional[str] = Field(None, examples=['123.45'])
	currency_id: Optional[str] = Field(
		None,
		description="Use either currency_id or currency_code. Defaults to the user's default currency.",
...
class Bill(BaseModel):
	...
	active: Optional[bool] = Field(None, description='If the bill is active.', examples=[True])
...
class CurrencyExchangeRateRead(BaseModel):
	type: str = Field(..., description='Immutable value', examples=['currency_exchange_rates'])
	id: str = Field(..., examples=['2'])
...
class RecurrenceTransaction(BaseModel):
	...
	bill_name: Optional[str] = Field(None, description='Optional. Use either this or the bill_id')
...
class RuleActionUpdate(BaseModel):
	...
	order: Optional[int] = Field(None, description='Order of the action', examples=[5])
	active: Optional[bool] = Field(None, description='If the action is active.', examples=[True])
	stop_processing: Optional[bool] = Field(
		None,
...
class RuleTriggerUpdate(BaseModel):
	...
	order: Optional[int] = Field(None, description='Order of the trigger', examples=[5])
	active: Optional[bool] = Field(None, description='If the trigger is active.', examples=[True])
	stop_processing: Optional[bool] = Field(
		None,
...
class UserGroupReadMembers(BaseModel):
	user_id: Optional[str] = Field(None, description='The ID of the member.', examples=['5'])
...
class PolymorphicProperty(RootModel[Union[bool, str, Dict[str, Any], List[StringArrayItem]]]):
